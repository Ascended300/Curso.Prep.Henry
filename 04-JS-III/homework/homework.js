...
function todosIguales(arreglo) {
    ...
    //Escribe tu código aquí  
    return arreglo.every((a) => arreglo[0] === a)
...
function mesesDelAño(array) {
    ...
    // Tu código:
    return (array.includes('Enero') && array.includes('Marzo') && array.includes('Noviembre')) ? array.filter((a) => a === 'Enero' || a === 'Marzo' || a === 'Noviembre') : 'No se encontraron los meses pedidos';
